    ...
    <section className="about" id="about">
      <div className="about-inner">
        <div className="about-text">
          <div ref={label.ref} className={`${label.className} section-label`}>About</div>
          <h2 ref={title.ref} className={`${title.className} section-title`}>Built for students.<br />Powered by AI.</h2>
